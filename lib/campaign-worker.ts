...
import { enqueueOutgoingJob } from "@/lib/queue";
import type { CampaignJobPayload } from "@/lib/campaign-execution";
...
export async function processCampaignOutgoingJob(
  payload: CampaignJobPayload, // mantém flexível pra compatibilidade com queue
) {
