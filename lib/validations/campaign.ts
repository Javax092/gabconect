...
export const campaignFiltersSchema = z.object({
  ...
  optInFilter: z.enum(["ALL", "OPT_IN", "SEM_OPT_IN", "OPT_OUT"]).optional().default("ALL"),
  contactStatus: z.enum(["ALL", "ACTIVE", "UNSUBSCRIBED", "BLOCKED", "INVALID"]).optional().default("ALL"),
  birthdayFilter: z.enum(["ALL", "WITH_BIRTHDAY", "TODAY"]).optional().default("ALL"),
